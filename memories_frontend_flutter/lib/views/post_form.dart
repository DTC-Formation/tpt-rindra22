...
class _PostFormState extends State<PostForm> {
    ...
    Future<void> addPost(List<XFile> pickedFiles, String title, String description) async {
        List<String> imagePaths = pickedFiles.map((pickedFile) => pickedFile.path).toList();
    ...
    void editOnPost(List<XFile> pickedFiles, String title, String description) async {
    ...
    Widget build(BuildContext context) {
        ...
        return Scaffold(
            body: _loading ? Center(child: CircularProgressIndicator(color: primary),) :  
                Container(
                    height: selectedImagesInitial.length > 0 ? size.height * 1 : size.height * 0.7,
                                                ...
                                                children: [
                                                    ...
                                                    Positioned(
                                                        ...
                                                        child: IconButton(
                                                            onPressed: (){
                                                                setState(() {
                                                                    selectedImagesInitial.removeAt(index);
                                                                });
                                                            },
                            ...
                            : Container(),
                                ...
                                Container(
                                    ...
                                    Padding(
                                        ...
                                        child: kTextButton(widget.post == null ? 'Create' : 'Update', (){
                                            if (_formKey.currentState!.validate()){
                                                ...
                                                if (widget.post == null) {
                                                   // _createPost();
                                                    addPost(pickedFiles!, _txtControllerTitle.text, _txtControllerDescription.text);
                                                } else {
                                                   //  _editPost(widget.post!.id ?? 0);
                                                   editOnPost(pickedFiles!, _txtControllerTitle.text, _txtControllerDescription.text);
                                                }
                                            }
                                        }),
                                    )
